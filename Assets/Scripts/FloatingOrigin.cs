...
public class FloatingOrigin : MonoBehaviour
{
   ...
   public  BulletFire BulletFireScript;
...
public class FloatingOrigin : MonoBehaviour
{
    ...
    public float threshold = 1000.0f; // wAs 100
    ...
    void //LateUpdate()
    {
        ...
        if (cameraPosition.magnitude > threshold)
        {
           ...
           // adding in to fix level manager
            Vector3 originDelta = Vector3.zero - cameraPosition;
            LevelManager.UpdateSpawnOrigin(originDelta);
            Debug.Log("Recentering" + originDelta);
...
/*        Vector3 originDelta = Vector3.zero - cameraPosition;
       levelManager.UpdateSpawnOrigin(originDelta);
        PlayerMotor.UpdateSpawnOrigin(originDelta);
        Debug.Log("recentering, origin delta = " + originDelta);
    }
}
}
